...
public class CorsConfig implements Filter {
    ...
    private final String[] allowedDomain = {"http://localhost:8080", "http://127.0.0.1:5173", "http://localhost:3000"};
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        System.out.println("origin:123123");
